CREATE TABLE uporabnik (id SERIAL PRIMARY KEY, ime VARCHAR(255) NOT NULL, priimek TEXT NOT NULL,uporabnisko_ime VARCHAR(255) NOT NULL,email VARCHAR(255) NOT NULL);
