...
public class Uporabnik {
    ...
    private List<KarticeSeznam> karticeSeznami;
    ...
    public List<KarticeSeznam> getKarticeSeznami() {

        if (karticeSeznami == null) {
            karticeSeznami = new ArrayList<>();
        }

        return karticeSeznami;
    }

    public void setKarticeSeznami(List<KarticeSeznam> karticeSeznami) {
        this.karticeSeznami = karticeSeznami;
    }
